catalog! {
    ...
    UPDATES_INVALID_OPERATION, "updates.invalid_operation", "Ungültiger Update-Vorgang", "Invalid update operation";
    UPDATES_INVALID_VERSION, "updates.invalid_version", "Ungültige Update-Version", "Invalid update version";
    UPDATES_REQUEST_FAILED, "updates.request_failed", "Update-Anfrage fehlgeschlagen", "Update request failed";
    UPDATES_CONTROLLER_UNAVAILABLE, "updates.controller_unavailable", "Update-Steuerung nicht erreichbar; vor einem erneuten Versuch den Status aktualisieren", "Update controller unavailable; refresh status before retrying";
    UPDATES_SETTINGS_SECTIONS, "updates.settings_sections", "Einstellungsbereiche", "Settings sections";
    UPDATES_GENERAL, "updates.general", "Allgemein", "General";
    UPDATES_TITLE, "updates.title", "Updates", "Updates";
    UPDATES_SOFTWARE, "updates.software", "Software-Updates", "Software updates";
    UPDATES_INTRO, "updates.intro", "Halte deine VaultLink-Installation auf dem neuesten Stand.", "Keep your VaultLink installation up to date.";
    UPDATES_INSTALLED, "updates.installed", "Installierte Version", "Installed version";
    UPDATES_LATEST, "updates.latest", "Neueste stabile Version", "Latest stable version";
    UPDATES_CURRENT_INSTALLATION, "updates.current_installation", "Auf diesem Server", "On this server";
    ...
    UPDATES_TRUST, "updates.trust", "Quelle: offizielle VaultLink-Releases auf GitHub. Vor der Installation prüft der Host-Updater die Paketsignatur.", "Source: official VaultLink releases on GitHub. Before installation, the host updater verifies the package signature.";
    UPDATES_AUTOMATIC_TITLE, "updates.automatic_title", "Automatische Updates", "Automatic updates";
    UPDATES_AUTOMATIC_HELP, "updates.automatic_help", "Entscheide, ob neue stabile Versionen automatisch installiert werden sollen.", "Choose whether new stable versions should be installed automatically.";
    UPDATES_AUTOMATIC_LABEL, "updates.automatic_label", "Stabile Updates automatisch installieren", "Install stable updates automatically";
    UPDATES_AUTOMATIC_DETAIL, "updates.automatic_detail", "Tägliche Prüfung. Die Installation startet den Dienst neu und kann laufende Übertragungen unterbrechen.", "Daily check. Installation restarts the service and may interrupt active transfers.";
    UPDATES_AUTOMATIC_OFF, "updates.automatic_off", "Deaktiviert · Du startest Installationen selbst.", "Disabled · You start installations manually.";
    UPDATES_AUTOMATIC_ON, "updates.automatic_on", "Aktiviert · Neue stabile Versionen werden automatisch installiert.", "Enabled · New stable versions will be installed automatically.";
    UPDATES_CONFIRM_EYEBROW, "updates.confirm_eyebrow", "Manuelles Update", "Manual update";
    UPDATES_CONFIRM_TITLE, "updates.confirm_title", "Update jetzt installieren?", "Install update now?";
    UPDATES_CONFIRM_HELP, "updates.confirm_help", "Der Updater prüft das signierte Paket und erstellt vor der Installation eine Sicherung.", "The updater verifies the signed package and creates a backup before installation.";
    UPDATES_CONFIRM_RESTART, "updates.confirm_restart", "VaultLink wird kurzzeitig nicht erreichbar sein. Laufende Übertragungen können unterbrochen werden.", "VaultLink will be temporarily unavailable. Active transfers may be interrupted.";
    UPDATES_CANCEL, "updates.cancel", "Abbrechen", "Cancel";
    UPDATES_CONFIRM_INSTALL, "updates.confirm_install", "Jetzt installieren", "Install now";
    UPDATES_READY, "updates.ready", "Bereit zur Update-Prüfung", "Ready to check for updates";
    UPDATES_READY_HELP, "updates.ready_help", "Prüfe, ob eine neue stabile Version auf GitHub verfügbar ist.", "Check whether a new stable version is available on GitHub.";
    UPDATES_CHECKING, "updates.checking", "Updates werden geprüft …", "Checking for updates …";
    UPDATES_CHECKING_HELP, "updates.checking_help", "Die neueste stabile Version wird ermittelt.", "Looking up the latest stable version.";
    UPDATES_AVAILABLE, "updates.available", "Ein Update ist verfügbar", "An update is available";
    UPDATES_AVAILABLE_HELP, "updates.available_help", "Du kannst das Update jetzt installieren oder später zurückkehren.", "You can install the update now or return later.";
    UPDATES_CURRENT, "updates.current", "VaultLink ist aktuell", "VaultLink is up to date";
    UPDATES_CURRENT_HELP, "updates.current_help", "Es ist keine neuere stabile Version verfügbar.", "No newer stable version is available.";
    UPDATES_CHECKED, "updates.checked", "Zuletzt geprüft:", "Last checked:";
    UPDATES_INSTALLING, "updates.installing", "Update wird installiert …", "Installing update …";
    UPDATES_INSTALLING_HELP, "updates.installing_help", "Die Installation läuft. Der Status wird automatisch aktualisiert.", "Installation is in progress. The status will update automatically.";
    UPDATES_SUCCESS, "updates.success", "Update erfolgreich abgeschlossen", "Update completed successfully";
    UPDATES_SUCCESS_HELP, "updates.success_help", "Die neue Version ist gestartet und erreichbar.", "The new version has started and is reachable.";
    UPDATES_ERROR, "updates.error", "Update-Prüfung fehlgeschlagen", "Update check failed";
    UPDATES_ERROR_HELP, "updates.error_help", "Die Release-Quelle konnte nicht erreicht werden. Bitte versuche es erneut.", "The release source could not be reached. Please try again.";
    UPDATES_INSTALL_FAILED, "updates.install_failed", "Update nicht abgeschlossen", "Update did not complete";
    UPDATES_INSTALL_FAILED_HELP, "updates.install_failed_help", "Der Update-Vorgang ist fehlgeschlagen oder wurde unterbrochen. Bitte den angezeigten Versionsstand und das Serverprotokoll prüfen.", "The update failed or was interrupted. Please check the displayed version and the server log.";
    UPDATES_SAVING, "updates.saving", "Einstellung wird gespeichert …", "Saving setting …";
    UPDATES_SAVE_FAILED, "updates.save_failed", "Die Einstellung konnte nicht gespeichert werden. Bitte versuche es erneut.", "The setting could not be saved. Please try again.";
    SHARE_SEARCH_TOO_SHORT, "share.search_too_short", "Bitte mindestens drei Zeichen eingeben oder die Suche leeren.", "Enter at least three characters or clear the search.";
