...
catalog! {
    ...
    SETUP_ROOT_MOUNT_PATH_HELP, "setup.root_mount_path_help", "Der sichtbare Dateibaum, den VaultLink durchsucht und über Freigabelinks bereitstellt. Bei einem Mount unter /mnt/storage bleibt er deshalb auf /mnt/storage/shared; das private interne Verzeichnis liegt als geschützter Geschwisterpfad daneben.", "The visible file tree VaultLink browses and exposes through share links. For a mount at /mnt/storage it therefore remains /mnt/storage/shared, with the private internal directory beside it as a protected sibling.";
    ...
    SETUP_ADMIN_PASSWORD_HELP, "setup.admin_password_help", "Passwort des ersten Administrators mit mindestens 14 Zeichen; es wird mit Argon2id gespeichert.", "Password for the first administrator with at least 14 characters; it is stored using Argon2id.";
