...
- Advanced the stable toolchain, canonical Docker smoke image, and native package-builder recipe to Rust 1.98.0; the previous builder digests remain deliberately unprovisioned until the protected refresh emits reviewed replacements.
