...
sed -i 's/^expected_version=0.7.2$/expected_version=0.7.1/' "$old_version_evidence/result.env"
...
grep -F -q 'soak did not exercise VaultLink 0.7.2' "$work/old-version.log" \
