...
- [ ] Checksum-pinned Gitleaks 8.30.1 full-history scan is green with redacted output; `.gitleaksignore` contains only the two reviewed RFC 6238 TOTP test-vector fingerprints.
